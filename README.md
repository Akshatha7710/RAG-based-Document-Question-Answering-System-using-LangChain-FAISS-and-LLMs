...
-  This project demonstrates the use of Generative AI, embeddings, vector databases, and LLM pipelines to build an intelligent document assistant.
...
-  Scalable RAG pipeline architecture
